...
cleaned_data <- raw_data %>% 
  filter(!str_detect(hrs1, '.i'), !str_detect(hrs1, '.n'), 
         ...
         !str_detect(happy, '.s'))
cleaned_data$rincome <- sub("-","TO",cleaned_data$rincome)
cleaned_data$rincome <- sub("LT","LOWER THEN ",cleaned_data$rincome)
cleaned_data$hrs1 <- as.numeric(cleaned_data$hrs1)
cleaned_data$rincome <- factor(cleaned_data$rincome,
