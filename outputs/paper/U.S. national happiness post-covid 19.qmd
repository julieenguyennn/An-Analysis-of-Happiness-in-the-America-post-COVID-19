...
Happiness was self-measured by the respondents using the survey asking how happy they felt. It is scaled as "not too happy", "pretty happy", "very happy". Two people responded as either did not know or left blank. The age variables "inapplicable", "no answer", "do not know". The participant's sex was measured as "male" and "female" with a small percentage (2.2%) of "Not Applicable" and "No answer". For Race 
