...
There are also ethical factors that should be taken into consideration. Regarding the race of respondents, there is only options for White, Black, and Others.

The fact that being a voluntary survey is the limitation -> cannot generalize, hence not reflecting the whole population
